...
public class JdbcTemplateMemberRepository implements MemberRepository { // alt + shift + enter

    private final JdbcTemplate jdbcTemplate;

    @Autowired // 생성자가 하나일 경우에는 @Autowired 생략 가능
